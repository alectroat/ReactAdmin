...
namespace API_Project.Controller
{
    public class RegisterController: ApiController
    {
        ...
        [HttpPost]
        public IHttpActionResult Registration(Registration Registration)
        {
            try
            {
                _Response.Data = repository.Registration(Registration);
            }
            catch (Exception ex)
            {
                _Response.Message = ex.Message.ToString();
        ...
        [Route("api/Register/AllUser")]
        [HttpGet]
        public IHttpActionResult AllRegistrationData()
        {
            try
            {
                _Response.Data = repository.Registrations.ToList<Registration>();
            }
            catch (Exception ex)
            {
                _Response.Message = ex.Message.ToString();
